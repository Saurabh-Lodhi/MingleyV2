...
public class SubscriptionService : ISubscriptionService
{
    ...
    public async Task<SubscribeResponse> SubscribeAsync(Guid userId, SubscribeRequest req)
    {
        ...
        // IX_UserSubscriptions_UserId is a UNIQUE constraint — each user has at most
        // ONE row in this table, ever. So we upsert that single row instead of
        // deactivating-and-inserting (which violates the constraint on resubscribe).
