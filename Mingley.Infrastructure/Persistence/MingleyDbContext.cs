...
public class MingleyDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder mb)
    {
        ...
        mb.Entity<CoinTransaction>().HasData(
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000001"), UserId = rahulId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "admin", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000002"), UserId = rahulId, Coins = 5000, Direction = "credit", Description = "Deposit — 5000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 1, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000003"), UserId = rahulId, Coins = 30, Direction = "debit", Description = "Audio call · 3 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 2, 5, 3, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000004"), UserId = arjunId, Coins = 500, Direction = "debit", Description = "Video call · 5 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 3, 3, 5, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000005"), UserId = arjunId, Coins = 10000, Direction = "credit", Description = "Deposit — 10000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000006"), UserId = nikhilId, Coins = 2000, Direction = "debit", Description = "Video call · 20 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 5, 9, 20, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000007"), UserId = nikhilId, Coins = 10000, Direction = "credit", Description = "Deposit — 10000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000008"), UserId = priyaId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "admin", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000009"), UserId = aishaId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "admin", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("61000001-0000-0000-0000-000000000010"), UserId = aishaId, Coins = 50, Direction = "credit", Description = "Profile verified bonus", TransactionType = "admin", CreatedAt = new DateTime(2024, 1, 1, 1, 0, 0, DateTimeKind.Utc) }
        );

        // ── Reports (safety edge cases) ────────────────────────────────
        mb.Entity<Report>().HasData(
            new Report { Id = Guid.Parse("71000001-0000-0000-0000-000000000001"), ReporterId = priyaId, ReportedUserId = deepakId, Reason = "spam", Description = "Sending repeated unsolicited messages", Status = "pending", CreatedAt = new DateTime(2024, 1, 8, 0, 0, 0, DateTimeKind.Utc) },
            new Report { Id = Guid.Parse("71000001-0000-0000-0000-000000000002"), ReporterId = aishaId, ReportedUserId = sureshId, Reason = "harassment", Description = "Inappropriate language", Status = "reviewed", AdminNote = "Warning issued", CreatedAt = new DateTime(2024, 1, 9, 0, 0, 0, DateTimeKind.Utc) }
        );

        // ── Blocks (safety edge cases) ─────────────────────────────────
        mb.Entity<Block>().HasData(
            new Block { Id = Guid.Parse("81000001-0000-0000-0000-000000000001"), BlockerId = priyaId, BlockedUserId = deepakId, CreatedAt = new DateTime(2024, 1, 8, 1, 0, 0, DateTimeKind.Utc) }
        );
    }
}
