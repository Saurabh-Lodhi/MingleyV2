...
public class MingleyDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder mb)
    {
        ...
        mb.Entity<CoinTransaction>().HasData(
            new CoinTransaction { Id = Guid.Parse("a3000001-0000-0000-0000-000000000001"), UserId = rahulId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "welcome", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000002-0000-0000-0000-000000000002"), UserId = rahulId, Coins = 5000, Direction = "credit", Description = "Deposit — 5000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 1, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000003-0000-0000-0000-000000000003"), UserId = rahulId, Coins = 50, Direction = "debit", Description = "Audio call · 5 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 3, 14, 5, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000004-0000-0000-0000-000000000004"), UserId = arjunId, Coins = 10000, Direction = "credit", Description = "Deposit — 10000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000005-0000-0000-0000-000000000005"), UserId = arjunId, Coins = 700, Direction = "debit", Description = "Video call · 7 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 3, 10, 7, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000006-0000-0000-0000-000000000006"), UserId = nikhilId, Coins = 10000, Direction = "credit", Description = "Deposit — 10000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000007-0000-0000-0000-000000000007"), UserId = nikhilId, Coins = 1500, Direction = "debit", Description = "Video call · 15 min", TransactionType = "call", CreatedAt = new DateTime(2024, 1, 5, 19, 15, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000008-0000-0000-0000-000000000008"), UserId = devId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "welcome", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000009-0000-0000-0000-000000000009"), UserId = devId, Coins = 10000, Direction = "credit", Description = "Deposit — 10000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 2, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000010-0000-0000-0000-000000000010"), UserId = priyaId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "welcome", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000011-0000-0000-0000-000000000011"), UserId = priyaId, Coins = 50, Direction = "credit", Description = "Verification bonus", TransactionType = "verification", CreatedAt = new DateTime(2024, 1, 1, 2, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000012-0000-0000-0000-000000000012"), UserId = aishaId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "welcome", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000013-0000-0000-0000-000000000013"), UserId = aishaId, Coins = 50, Direction = "credit", Description = "Verification bonus", TransactionType = "verification", CreatedAt = new DateTime(2024, 1, 1, 2, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000014-0000-0000-0000-000000000014"), UserId = shivId, Coins = 12000, Direction = "credit", Description = "Deposit — 12000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000015-0000-0000-0000-000000000015"), UserId = ishitaId, Coins = 100, Direction = "credit", Description = "Welcome bonus", TransactionType = "welcome", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000016-0000-0000-0000-000000000016"), UserId = ishitaId, Coins = 5000, Direction = "credit", Description = "Deposit — 5000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 2, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000017-0000-0000-0000-000000000017"), UserId = amanId, Coins = 6000, Direction = "credit", Description = "Deposit — 6000 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new CoinTransaction { Id = Guid.Parse("a3000018-0000-0000-0000-000000000018"), UserId = kabirId, Coins = 3800, Direction = "credit", Description = "Deposit — 3800 coins", TransactionType = "deposit", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        );

        // ── Reports (safety testing) ──────────────────────────────────────
        mb.Entity<Report>().HasData(
            new Report { Id = Guid.Parse("a4000001-0000-0000-0000-000000000001"), ReporterId = priyaId, ReportedUserId = deepakId, Reason = "spam", Description = "Sending repeated unsolicited messages", Status = "pending", CreatedAt = new DateTime(2024, 2, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Report { Id = Guid.Parse("a4000002-0000-0000-0000-000000000002"), ReporterId = aishaId, ReportedUserId = sureshId, Reason = "harassment", Description = "Inappropriate language in DMs", Status = "reviewed", CreatedAt = new DateTime(2024, 2, 2, 0, 0, 0, DateTimeKind.Utc) },
            new Report { Id = Guid.Parse("a4000003-0000-0000-0000-000000000003"), ReporterId = poojaId, ReportedUserId = vivekId, Reason = "inappropriate_content", Description = "Shared offensive content", Status = "action_taken", CreatedAt = new DateTime(2024, 2, 3, 0, 0, 0, DateTimeKind.Utc) },
            new Report { Id = Guid.Parse("a4000004-0000-0000-0000-000000000004"), ReporterId = tanviId, ReportedUserId = ankitId, Reason = "fake_profile", Description = "Profile pictures appear to be stolen", Status = "pending", CreatedAt = new DateTime(2024, 2, 4, 0, 0, 0, DateTimeKind.Utc) }
        );

        // ── Blocks ───────────────────────────────────────────────────────
        mb.Entity<Block>().HasData(
            new Block { Id = Guid.Parse("a5000001-0000-0000-0000-000000000001"), BlockerId = priyaId, BlockedUserId = deepakId, CreatedAt = new DateTime(2024, 2, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Block { Id = Guid.Parse("a5000002-0000-0000-0000-000000000002"), BlockerId = aishaId, BlockedUserId = sureshId, CreatedAt = new DateTime(2024, 2, 2, 0, 0, 0, DateTimeKind.Utc) },
            new Block { Id = Guid.Parse("a5000003-0000-0000-0000-000000000003"), BlockerId = poojaId, BlockedUserId = vivekId, CreatedAt = new DateTime(2024, 2, 3, 0, 0, 0, DateTimeKind.Utc) }
        );
    }
}