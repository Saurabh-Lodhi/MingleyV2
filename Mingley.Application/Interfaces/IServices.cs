...
public interface IAuthService
{
    ...
    Task<ForgotPasswordResponse> ForgotPasswordAsync(ForgotPasswordRequest request); // UPDATED return type
...
public interface IUserService
{
    ...
    Task<List<ContactOnAppDto>> GetContactsOnAppAsync(List<string> phoneNumbers); // NEW
}
...
//    Task DeleteMessageAsync(Guid userId, Guid chatId, Guid messageId);
//    Task<ChatQuotaDto> GetQuotaAsync(Guid userId, Guid chatId);
//    Task<SendCoinsResponse> SendCoinsAsync(Guid senderId, Guid chatId, SendCoinsRequest request); // NEW
//}
