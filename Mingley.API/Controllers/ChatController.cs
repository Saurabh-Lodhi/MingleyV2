...
public class ChatsController : ControllerBase
{
    ...
    // NEW: POST /v1/chats/{chatId}/send-coins
    [HttpPost("{chatId}/send-coins")]
    public async Task<IActionResult> SendCoins(Guid chatId, [FromBody] SendCoinsRequest req)
    {
        var result = await _chat.SendCoinsAsync(Me, chatId, req);
        return Ok(ApiResponse<SendCoinsResponse>.Ok(result, $"💰 {req.CoinAmount} coins sent!"));
    }
}
