...
public class ExceptionMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext ctx)
    {
        ...
        catch (InvalidOperationException ex)
        {
            ...
            await Write(ctx, HttpStatusCode.BadRequest, ex.Message + " | Inner: " + ex.InnerException?.Message + " | " + ex.InnerException?.InnerException?.Message);
        }
        ...
        catch (Exception ex)
        {
            ...
            await Write(ctx, HttpStatusCode.InternalServerError, ex.Message + " | Inner: " + ex.InnerException?.Message + " | " + ex.InnerException?.InnerException?.Message);
        }
    }
